  ...
  GroupingButton.click(
    async function () {
      ...
      for (var i = 0; i < items.length; ++i) {
        ...
        var group = ''
        if (is('同人ゲーム') || is('アプリケーション') || is('ロールプレイング') || is('シミュレーション') || is('アドベンチャー') || is('アクション') || is('デジタルノベル') || is('シューティング') || is('パズル') || is('タイピング') || is('Flash') || is('HTML(Flash)') || is('その他ゲーム') || is('クイズ') || is('テーブル')) {
          group = 'ゲーム'
        } else if (is('CG集') || is('マンガ') || is('同人誌') || is('イラスト集') || is('CG・イラスト') || is('CG+ノベル') || is('デジタルコミック') || is('単話') || is('単行本') || is('雑誌/アンソロ') || (is('3DCG') && !is('動画'))) {
          group = 'マンガ & CG集'
        } else if (is('動画')) {
          group = '動画'
        } else if (is('音声')) {
